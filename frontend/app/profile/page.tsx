    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-16 px-4">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="glass rounded-3xl p-6 mb-6 opacity-0 animate-fade-in-up animate-fill-both animate-delay-300">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-semibold text-slate-100">Membership Application</h2>
                  <p className="text-xs text-slate-400 mt-0.5">Apply to become a BOD / Member of the organizing community</p>
                </div>
              </div>
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40 hover:from-amber-400 hover:to-orange-400 transition-all"
              >
