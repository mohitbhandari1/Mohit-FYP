...
export default function OrganizationDashboard() {
  ...
  const fetchPendingRequests = useCallback(async () => {
    if (!selectedCommunity) { setPendingRequests([]); setEventRequests([]); return; }
    ...
    try {
      ...
      if (!eventsRes.ok) { setPendingRequests([]); setEventRequests([]); return; }
      ...
      // New: event-level summary with unread (red badge) counts
