...
export default function CommunitiesPage() {
  ...
  const [related, setRelated] = useState<Community[]>([]);
    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-16 px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
          ...
          ) : communities.length === 0 && related.length === 0 ? (
            ...
            <>
              {communities.length === 0 && (
                <div className="text-center py-10 glass rounded-2xl mb-8 opacity-0 animate-fade-in-up animate-fill-both">
                  <p className="text-slate-300">
                    No exact matches for <span className="text-amber-300 font-medium">“{category}”</span>.
                  </p>
              ...
              {related.length > 0 && (
                <div className="mt-14 opacity-0 animate-fade-in-up animate-fill-both">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-slate-100">Related Communities</h2>
                      <p className="text-sm text-slate-400 mt-0.5">
                        Popular communities in similar categories
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
